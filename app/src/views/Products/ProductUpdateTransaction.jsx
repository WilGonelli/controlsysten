  ...
  return (
    ...
    >
      ...
      {item.transactions.length > 1 && (
        <ScrollView
          style={[
            styles.transitionsHistoryClient,
            { height: "32%", marginTop: 60 },
          ]}
        >
          <Text style={[globalStyle.textCustomButton, { textAlign: "center" }]}>
            Tabela de analise
          </Text>
          <View style={[globalStyle.containerItens, { height: "max-content" }]}>
          ...
          <View style={[globalStyle.containerItens, { height: "max-content" }]}>
            <Text style={globalStyle.textItens}>Lucro medio por unidade:</Text>
            <Text style={globalStyle.textItens}>
              R$
          ...
          <View style={[globalStyle.containerItens, { height: "max-content" }]}>
            <Text style={globalStyle.textItens}>Lucro medio total atual:</Text>
            <Text style={globalStyle.textItens}>
              R$
              {parseFloat((item.sellPrice - item.avgPrice) * item.quantitySell)
                .toFixed(2)
                .replace(".", ",")}
            </Text>
          </View>
